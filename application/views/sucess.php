...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Your verification process has completed.you can login from mobile application.</p>
...
-->
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="button" class="btn btn-primary btn-raised btn-block" onclick="closeWin()">Close window</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
