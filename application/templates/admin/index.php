...
-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <?php if($this->uri->segment(2)=="preorders" OR $this->uri->segment(2)=="predetail"): ?>
        <li class="<?php echo empty($uri2)? 'active':''; ?>"><a href="<?php echo base_url().'orders/preorders'; ?>"><i class="fa fa-dashboard"></i><?php echo ucfirst($this->uri->segment(1)); ?></a></li>
        <?php else: ?>
...
<!--Delete model -->
<!--Delete model -->
<div class="modal fade modal-fade-in-scale-up" id="confirm-tasks" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header alert-danger">
              ...
              <div class="modal-body">
                ...
                <p>Do you really want to Complete this shift ?</p>
            
              </div>
              <div class="modal-footer ">
                <a  href="javascript:void(0);" type="button" class="btn btn-outline btn-ok pull-right " data-dismiss="modal">No</a>
                <a href="javascript:void(0);" type="button" id="shiftUrl" class="btn btn-outline btn-danger btn-ok">Yes</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-light-blue">
                <button type="button" class="close" data-dismiss="modal"  style="color:#000 !important;" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
            ...
            <!-- /.modal-body -->
              <div class="modal-footer ">
                <a  href="javascript:void(0);" type="button" class="btn btn-outline btn-info btn-raised pull-right  " data-dismiss="modal">Close</a>
               <!--  <a href="javascript:void(0);" type="button" id="deleteUrl" class="btn btn-outline btn-danger btn-ok">Yes</a> -->
              </div>
            <!-- /.modal-content -->
          </div>
